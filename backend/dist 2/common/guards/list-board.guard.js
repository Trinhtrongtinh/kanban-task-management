...
let ListBoardGuard = class ListBoardGuard {
    reflector;
    boardMemberRepository;
    listRepository;
    boardRepository;
    constructor(reflector, boardMemberRepository, listRepository, boardRepository) {
    ...
    async canActivate(context) {
        ...
        const listId = request.params.listId || request.params.id || request.body?.listId;
        if (!listId) {
            return true;
        }
...
exports.ListBoardGuard = ListBoardGuard;
exports.ListBoardGuard = ListBoardGuard = __decorate([
    (0, common_1.Injectable)(),
    __param(1, (0, typeorm_1.InjectRepository)(entities_1.BoardMember)),
    __param(2, (0, typeorm_1.InjectRepository)(entities_1.List)),
...
//# sourceMappingURL=list-board.guard.js.map